  ...
  return (
    ...
    ">
      ...
      <nav className="flex items-center justify-center">
        ...
        <CustomLink className="mx-4" href="/network" title="Network" />
        <CustomLink className="mx-4" href="/weather" title="Weather" />
      ...
      </div>
    {
      ...
      <nav className="flex items-center justify-center flex-col">
        ...
        <CustomMobileLink toggle={handleClick} className="lg:m-0 lg:my-2" href="/network" title="Network" />
        <CustomMobileLink toggle={handleClick} className="lg:m-0 lg:my-2" href="/weather" title="Weather" />
